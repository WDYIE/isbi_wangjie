...
from  albumentations import CLAHE,MedianBlur,GaussNoise,Blur,IAASharpen,Cutout
...
def get_network(args, use_gpu=False):
    ...
    if args.net == 'vgg16':
        ...
        net = resnet50(args.num_class)
    elif args.net == 'resnet101':
        from models.resnet import resnet101
        net = resnet101(args.num_class)
...
def load_model_by_name(model,preModel):
